...
$sql1="SELECT * From products_tbl WHERE cat_id = '$id'";
$result1 = mysqli_query($connection,$sql1);
while($dataRow1=mysqli_fetch_assoc($result1)){

    $proId = $dataRow1['pro_code'];

	$sql = mysqli_query($connection,"SELECT * FROM products_tbl,stock_tbl,batch_tbl WHERE products_tbl.pro_code = '$proId' AND stock_tbl.pro_id = products_tbl.pro_id AND batch_tbl.batch_id = stock_tbl.batch_id AND batch_tbl.batch_location = '$location'");
