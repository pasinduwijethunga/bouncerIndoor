...
<body>
    ...
    <div class="page-wrapper">
                ...
                <div class="inner-container clearfix">
                    ...
                    <div class="logo-box">
                        <div class="logo"><a href="index.html" title="Linoor - DIgital Agency HTML Template"><img
                                    id="thm-logo" src="images/logo.png" alt="Linoor - DIgital Agency HTML Template"
                        ...
                        <nav class="main-menu navbar-expand-md navbar-light">
                            <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                <ul class="navigation clearfix">
                                    <li class="current dropdown"><a href="index-main.html">Home</a>
                                        <ul>
                                            <li><a href="index-main.html">Home Style 01</a></li>
                                            <li><a href="index-2.html">Home Style 02</a></li>
                                            <li><a href="index-3.html">Home Style 03</a></li>
                                            <li><a href="one-page.html">Home One Page</a></li>
                                            <li><a href="index-4.html">Home Style 04 <span>new</span></a></li>
                                            <li><a href="index-portfolio.html">Portfolio Home <span>new</span></a>
                                            </li>
                                            <li><a href="index-parallax.html">Parallax Home <span>new</span></a>
                                            </li>
                                            <li><a href="index-dark.html">Dark Home <span>new</span></a></li>
                                            <li><a href="index-boxed.html">Boxed Home <span>new</span></a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="dropdown"><a href="team.html">Pages</a>
                                        <ul>
                                            ...
                                            <li><a href="login.html">Login Page <span>new</span></a></li>
                                            <li><a href="register.php">Register Page <span>new</span></a></li>
                                            <li><a href="forgot-password.html">Forget Page <span>new</span></a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="dropdown"><a href="portfolio.php">Portfolio</a>
                                        <ul>
                                            ...
                                            <li><a href="dammika.php">Portfolio Single 01</a></li>
                ...
                <div class="sec-title">
                    ...
                    <div class="row clearfix">
                        <div class="column col-xl-6 col-lg-12 col-md-12 col-sm-12">
                            <h2>LET’S CREATE SOMETHING <br>together<span class="dot">.</span></h2>
                        </div>
                        <div class="column col-xl-6 col-lg-12 col-md-12 col-sm-12">
                                ...
                                <div class="inner-box">
                                    ...
                                    <div class="cap-box">
                                        <div class="cap-inner">
                                            ...
                                            <div class="title">
                                                <h5><a href="dammika.php">Fimlor Experience</a></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <section class="features-section jarallax" data-jarallax data-speed="0.3" data-imgPosition="50% -100%">
            ...
            <img src="images/background/image-3.jpg" class="jarallax-img" alt="">
            <div class="auto-container">
                <div class="content-box">
